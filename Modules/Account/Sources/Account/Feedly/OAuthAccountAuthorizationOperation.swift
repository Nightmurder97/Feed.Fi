...
@objc public final class OAuthAccountAuthorizationOperation: NSObject, ASWebAuthenticationPresentationContextProviding {
	...
	private func didFinish() {
		...
		completionBlock?(self as? MainThreadOperation ?? MainThreadOperation())
		// Note: Since this class doesn't inherit from MainThreadOperation, we need custom handling
	}
